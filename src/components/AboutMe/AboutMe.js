          ...
          <nav>
            <ul className="about-me__list">
              <li className="about-me__element">
                <a href="https://www.facebook.com/" target="_blank" className="about-me__link" rel="noreferrer">Facebook</a>
              </li>
              <li className="about-me__element">
                <a href="https://github.com/JettPy" target="_blank" className="about-me__link" rel="noreferrer">Github</a>
              </li>
            </ul>
          </nav>
        </div>
